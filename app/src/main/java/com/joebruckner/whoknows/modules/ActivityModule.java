...
import com.joebruckner.whoknows.presenters.MapPresenterImpl;
...
public class ActivityModule {
    ...
    @Provides @Singleton
    MapPresenter providesMapPresenter(LocationManager locationManager) {
        return new MapPresenterImpl(locationManager, activity);
    }
}
